...
export interface CustomVariableJson {
    ...
    value: string,
    /**
     * States whether the value is automatically generated by an auto splitter,
     * component or through other means and therefore should not be edited by
     * the user. Automatically provided values also don't get stored in the
     * splits file.
     */
    is_automatically_provided: boolean,
    /**
     * States whether the value is only meaningful for a single attempt and
     * therefore should be reset between attempts.
     */
    resets_between_attempts: boolean,
}
